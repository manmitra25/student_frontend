...
// Assuming you are using radix-ui/react-dialog version 1.1.6 or similar
import * as DialogPrimitive from "@radix-ui/react-dialog"; 
import { XIcon } from "lucide-react";

// Assuming cn and utils are set up as per shadcn/ui or similar style
...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        // Aggressive Z-INDEX fix applied: z-[9998] for the overlay 
  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          // Aggressive Z-INDEX fix applied: z-[9999] for the content
